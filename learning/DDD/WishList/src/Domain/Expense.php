...
final class Expense
{
    ...
    public function __construct(Money $price, Money $fee, Money $initialFund)
    {
        $this->price = $price;
        $this->fee = $fee;
    ...
    public static function fromCurrencyAndScalars(Currency $currency, int $price, int $fee, int $initialFund = null)
    {
