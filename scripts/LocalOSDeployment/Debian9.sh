...
apt update;
apt install php7.1-common php7.1-readline php7.1-fpm php7.1-cli  php7.1-mysql php7.1-mcrypt php7.1-curl php7.1-mbstring php7.1-opcache php7.1-json php7.1-mysql php7.1-xml php7.1-zip php7.1-sqlite php7.1-memcached php7.1-memcache php7.1-soap php7.1-bcmath php7.1-pgsql php-xdebug -y;
...
if [ ${homeEditionFlag} -eq 1 ] ; then
    ...
    gdebi plexmediaserver_1.9.7.4460-a39b25852_amd64.deb;
    rm plexmediaserver_1.9.7.4460-a39b25852_amd64.deb;
