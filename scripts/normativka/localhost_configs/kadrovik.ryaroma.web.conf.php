...
define("MEMCACHE_NAMESPACE", 'kadrovik.by');
define("MEMCACHE_ACTIVE", (bool)'0');

define("SITE_ALIAS", "kadrovik.ryaroma.web");
...
define("SHARED_DOCS_PATH", '/home/gutsout/h/normativka/var/user_data/shared_docs/kadrovik');
define("SITE_NAMESPACE", 'kadrovik');

define("TEMPLATE_DIR", "__templates/");
define("TEMPLATE_COMPILE_DIR", "/home/gutsout/h/normativka/var/templates_compiled/kadrovik.ryaroma.web/");
define("TPL_DIR_ADMIN", "Acp/");
define("TPL_DIR_SITE", "kadrovik.by/");

define("SITE_PASSPORT_ID", (int)'2');
...
define("PHOTOGALLERY_DIR", '/home/gutsout/h/normativka/var/user_data/photos/kadrovik');
define("NEWS_IMAGE_DIR", '/home/gutsout/h/normativka/var/site_data/pictures/kadrovik/news/');
define("MAGARTICLES_IMAGE_DIR", '/home/gutsout/h/normativka/var/site_data/pictures/kadrovik/magazine-articles/');
...
define("LAST_TOPICS_STOP_RUBRIC_ID", '5'); // не показывать сообщения из данных рубрик в списке на главной форума (можно через запятую, например: '11,12,33')
...
define("WEBPAY_STORE_ID", '963044175');
define("WEBPAY_STORE_NAME", 'Кадровик.by');
...
if (isset($_SERVER['HTTP_HTTPS']) && $_SERVER['HTTP_HTTPS'] == 'on'
	...
	define("WWW_URL", "https://kadrovik.ryaroma.web");
	define("PROTOCOL", "https://");
} else {
	define("WWW_URL", "http://kadrovik.ryaroma.web");
