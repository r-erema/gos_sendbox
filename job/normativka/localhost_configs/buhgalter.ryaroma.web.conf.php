...
define("MEMCACHE_NAMESPACE", 'buhgalter.by');
define("MEMCACHE_ACTIVE", (bool)'0');

define("SITE_ALIAS", "buhgalter.ryaroma.web");
...
define("SHARED_DOCS_PATH", '/home/gutsout/h/normativka/var/user_data/shared_docs/buhgalter');
define("SITE_NAMESPACE", 'buhgalter');

define("TEMPLATE_DIR", "__templates/");
define("TEMPLATE_COMPILE_DIR", "/home/gutsout/h/normativka/var/templates_compiled/buhgalter.ryaroma.web/");
define("TPL_DIR_ADMIN", "Acp/");
define("TPL_DIR_SITE", "buhgalter.by/");

define("SITE_PASSPORT_ID", (int)'1');
...
define("PHOTOGALLERY_DIR", '/home/gutsout/h/normativka/var/user_data/photos/buhgalter');
define("NEWS_IMAGE_DIR", '/home/gutsout/h/normativka/var/site_data/pictures/buhgalter/news/');
define("MAGARTICLES_IMAGE_DIR", '/home/gutsout/h/normativka/var/site_data/pictures/buhgalter/magazine-articles/');
...
define("LAST_TOPICS_STOP_RUBRIC_ID", '11'); // не показывать сообщения из данных рубрик в списке на главной форума (можно через запятую, например: '11,12,33')
...
define("WEBPAY_STORE_ID", '446660537');
define("WEBPAY_STORE_NAME", 'Бухгалтер.by');
...
if (isset($_SERVER['HTTP_HTTPS']) && $_SERVER['HTTP_HTTPS'] == 'on'
	...
	define("WWW_URL", "https://buhgalter.ryaroma.web");
	define("PROTOCOL", "https://");
} else {
	define("WWW_URL", "http://buhgalter.ryaroma.web");
