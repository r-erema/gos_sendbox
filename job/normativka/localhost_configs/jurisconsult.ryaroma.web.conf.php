...
define("MEMCACHE_NAMESPACE", 'jurisconsult.by');
define("MEMCACHE_ACTIVE", (bool)'0');

define("SITE_ALIAS", "jurisconsult.ryaroma.web");
...
define("SHARED_DOCS_PATH", '/home/gutsout/h/normativka/var/user_data/shared_docs/jurisconsult');
define("SITE_NAMESPACE", 'jurisconsult');

define("TEMPLATE_DIR", "__templates/");
define("TEMPLATE_COMPILE_DIR", "/home/gutsout/h/normativka/var/templates_compiled/jurisconsult.ryaroma.web/");
define("TPL_DIR_ADMIN", "Acp/");
define("TPL_DIR_SITE", "jurisconsult.by/");

define("SITE_PASSPORT_ID", (int)'4');
...
define("PHOTOGALLERY_DIR", '/home/gutsout/h/normativka/var/user_data/photos/jurisconsult');
define("NEWS_IMAGE_DIR", '/home/gutsout/h/normativka/var/site_data/pictures/jurisconsult/news/');
define("MAGARTICLES_IMAGE_DIR", '/home/gutsout/h/normativka/var/site_data/pictures/jurisconsult/magazine-articles/');
...
define("LAST_TOPICS_STOP_RUBRIC_ID", '14'); // не показывать сообщения из данных рубрик в списке на главной форума (можно через запятую, например: '11,12,33')
...
if (isset($_SERVER['HTTP_HTTPS']) && $_SERVER['HTTP_HTTPS'] == 'on'
    ...
    define("WWW_URL", "https://jurisconsult.ryaroma.web");
    define("PROTOCOL", "https://");
} else {
    define("WWW_URL", "http://jurisconsult.ryaroma.web");
