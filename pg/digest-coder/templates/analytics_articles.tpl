...
<table width="620" cellspacing="0" cellpadding="0" border="0">
    {foreach from = $data.analytics_arts.buh.arts key=id item=art}
        <tr>
            ...
            <td width="544" valign="top">
                <p style="font-family: Arial,Helvetica, sans-serif; font-size: 15px; font-weight: normal; margin-top: 0; margin-bottom: 3px;"><a href="{$art.link}" style="color: #134c95;">{$art.title}</a></p>
                {foreach from=$art.paragraphs key=k item=text }
                    <p style="font-family: Arial,Helvetica, sans-serif; font-size: 13px; margin-top: 0; margin-bottom: 3px;">{$text}</p>
                {/foreach}
...
<!-- FOR KADROVIK CONTENT START -->
    <table width="620" cellspacing="0" cellpadding="0" border="0">
        {foreach from = $data.analytics_arts.kadr.arts key=id item=art}
            <tr>
                <td width="64" valign="top">
                    <img src="http://normativka.by/pictures/video/authors/{$art.photo}" alt="" style="margin-top: 3px;" width="64" height="64" />
                </td>
...
<!-- FOR JURIST CONTENT START -->
    <table width="620" cellspacing="0" cellpadding="0" border="0">
        {foreach from = $data.analytics_arts.jur.arts key=id item=art}
            <tr>
                <td width="64" valign="top">
                    <img src="http://normativka.by/pictures/video/authors/{$art.photo}" alt="" style="margin-top: 3px;" width="64" height="64" />
                </td>
