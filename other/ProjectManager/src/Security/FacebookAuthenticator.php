...
use other\ProjectManager\src\Controller\Auth\FacebookController;
use other\ProjectManager\src\Controller\IndexController;
use other\ProjectManager\src\Model\User\UseCase\Network\Auth\Command;
use other\ProjectManager\src\Model\User\UseCase\Network\Auth\Handler;
...
class FacebookAuthenticator extends SocialAuthenticator
{
    ...
    {
        return $request->attributes->get('_route') === FacebookController::CHECK_ROUTE;
    }
    ...
    {
        return new RedirectResponse($this->urlGenerator->generate(IndexController::INDEX_ROUTE));
    }
